...
#   path = "/Repos/{data.databricks_current_user.me.user_name}/packaged-poc-mlops/_data_generator/data_cleanup"
# }

# resource "databricks_notebook" "data_setup" {
#   path = "/Repos/{data.databricks_current_user.me.user_name}/packaged-poc-mlops/_data_generator/data_setup"
# }
